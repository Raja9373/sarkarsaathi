...
const BANKING_TYPES = [
  ...
  { slug: 'nomination', name: 'Nomination', desc: 'Add nominee to account', icon: 'Users' },
  { slug: 'kyc', name: 'KYC', desc: 'Know Your Customer update', icon: 'CreditCard' },
...
const FINDERS = [
  ...
  { slug: 'ifsc', name: 'IFSC Finder', desc: 'Bank IFSC code', icon: 'Search', placeholder: 'Enter bank or branch' },
  { slug: 'micr', name: 'MICR Finder', desc: 'MICR code lookup', icon: 'Search', placeholder: 'Enter bank name' },
  ...
  { slug: 'hospital', name: 'Hospital Finder', desc: 'Govt hospitals near you', icon: 'Heart', placeholder: 'Enter locality' },
  { slug: 'blood-bank', name: 'Blood Bank Finder', desc: 'Blood availability', icon: 'Droplet', placeholder: 'Blood group + area' },
  { slug: 'passport-seva', name: 'Passport Seva Kendra', desc: 'PSK locations', icon: 'FileText', placeholder: 'Enter city' },
  ...
  { slug: 'jan-aushadhi', name: 'Jan Aushadhi Finder', desc: 'Cheap medicine stores', icon: 'Heart', placeholder: 'Enter area' },
  { slug: 'rto', name: 'RTO Finder', desc: 'RTO code & office', icon: 'Car', placeholder: 'Vehicle number e.g. DL01' },
  { slug: 'court', name: 'Court Finder', desc: 'District & high courts', icon: 'Scale', placeholder: 'Enter district' },
  { slug: 'district-office', name: 'District Office Finder', desc: 'Collector & DM office', icon: 'Building', placeholder: 'District name' },
  { slug: 'government-office', name: 'Government Office Finder', desc: 'All govt offices', icon: 'Building', placeholder: 'Department name' },
  { slug: 'government-school', name: 'Government School Finder', desc: 'Govt schools list', icon: 'GraduationCap', placeholder: 'Area or school name' },
  { slug: 'government-hospital', name: 'Government Hospital Finder', desc: 'Hospital directory', icon: 'Heart', placeholder: 'Speciality or area' },
  { slug: 'electricity-office', name: 'Electricity Office Finder', desc: 'BSES, TPDDL offices', icon: 'Zap', placeholder: 'Enter colony' },
  { slug: 'water-office', name: 'Water Office Finder', desc: 'DJB offices', icon: 'Droplet', placeholder: 'Zone' },
  { slug: 'gas-agency', name: 'Gas Agency Finder', desc: 'LPG distributors', icon: 'Building', placeholder: 'Enter area' },
  ...
  { slug: 'polling-booth', name: 'Polling Booth Finder', desc: 'Voter booth location', icon: 'Check', placeholder: 'Enter EPIC or area' },
  { slug: 'sdm-office', name: 'SDM Office Finder', desc: 'Sub-divisional magistrate', icon: 'Building', placeholder: 'Sub-division' },
  { slug: 'district-magistrate', name: 'District Magistrate Finder', desc: 'DM office contact', icon: 'Landmark', placeholder: 'District' },
  { slug: 'post-office', name: 'Post Office Finder', desc: 'Post offices & speed post', icon: 'Files', placeholder: 'Locality' },
];
...
const LIFE_EVENTS = [
  ...
  { slug: 'school-admission', name: 'School Admission', desc: 'Govt school, scholarship', icon: 'GraduationCap', color: '#ff8533', services: ['domicile-certificate', 'income-certificate'], timeline: '3-18 years' },
  ...
  { slug: 'lost-documents', name: 'Lost Documents', desc: 'FIR, reissue process', icon: 'Search', color: '#ff8533', services: ['fir-online', 'aadhaar-card', 'pan-card'], timeline: '7-21 days' },
  ...
  { slug: 'disability-support', name: 'Disability Support', desc: 'Certificate, benefits, pension', icon: 'Heart', color: '#ff8533', services: ['disability-certificate'], timeline: '15-45 days' },
];
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-3">
          {display.map(s=>(
            <button key={s.slug} onClick={()=>navigate(`/service/${s.slug}`)} className="text-left p-4 rounded-2xl bg-[#121212] border border-white/5 hover:border-[#ff6b00]/30 group">
              ...
              <div className="font-semibold text-[14px] mt-3">{s.title}</div><div className="text-[12px] text-white/50 mt-1 line-clamp-2">{s.overview.slice(0,90)}...</div><div className="mt-3 flex items-center gap-2 text-[11px] text-white/30"><Globe className="w-3 h-3" />{(function(){try{return new URL(s.officialUrl).hostname}catch{return 'gov.in'}})()}</div>
            </button>
          ))}
        </div>
        )}
