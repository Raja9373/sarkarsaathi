...
const HomePage: React.FC<{ navigate:any }> = ({ navigate }) => {
  ...
  const filtered = useMemo(()=>{
    ...
    const combined = [...serviceHits, ...catHits, ...finderHits, ...bankHits];
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 pt-10 md:pt-20 pb-8">
        ...
        <div className="mt-14">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
            {BLOGS.map(b=>(
              <div key={b.slug} onClick={()=>window.scrollTo({top:0, behavior:'smooth'})} className="p-5 rounded-2xl bg-[#121212] border border-white/5 hover:border-[#ff6b00]/30 hover:bg-[#1a1a1a] transition cursor-pointer group">
