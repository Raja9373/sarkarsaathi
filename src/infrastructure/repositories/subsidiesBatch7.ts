...
export const SUBSIDIES_BATCH_7: Subsidy[] = Array.from({ length: 100 }, (_, i) => {
  const index = i + 601;
  const id = `SUB-${String(index).padStart(3, '0')}`;
  const sector = 'Agriculture & Farmers Welfare';
  ...
  return {
    ...
    department: 'Department of Agricultural Subsidy Management',
    ...
    subsidyPercentage: '30% of eligible project cost',
    ...
    applicationProcess: 'Apply online through the respective state portal.',
