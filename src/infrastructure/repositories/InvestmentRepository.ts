import { publishedOpportunities } from './opportunitiesData';
import { tendersDataPart1 } from './tendersDataPart1';
import { tendersDataPart2 } from './tendersDataPart2';
...
export class OpportunityRepository implements Repository<Opportunity> {
  private items: Opportunity[] = [...publishedOpportunities];
