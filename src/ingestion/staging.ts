    ...
    for (const staged of this.stagedOpportunities) {
      ...
      if (isApproved) {
        ...
        const cleanOpportunity: Opportunity = {
          ...
          projectDescription: staged.projectDescription,
          opportunityDescription: staged.opportunityDescription,
          authority: staged.authority,
          promoter: staged.promoter,
          implementingAgency: staged.implementingAgency,
          ...
          lastVerifiedDate: staged.lastVerifiedDate || staged.provenance?.importedAt?.slice(0, 10),
          ...
          projectStage: staged.projectStage,
          landLocationDetails: staged.landLocationDetails,
          infrastructureDetails: staged.infrastructureDetails,
          investorProfile: staged.investorProfile,
          eligibility: staged.eligibility,
          requiredDocuments: staged.requiredDocuments,
          importantConditions: staged.importantConditions,
          participationProcess: staged.participationProcess,
          applicationProcess: staged.applicationProcess,
          contactInformation: staged.contactInformation,
          howToEvaluate: staged.howToEvaluate,
          faqs: staged.faqs,
          employmentPotential: staged.employmentPotential,
          completenessLevel: staged.completenessLevel
        };
